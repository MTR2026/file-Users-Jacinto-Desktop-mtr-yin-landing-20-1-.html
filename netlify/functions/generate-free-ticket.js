...
async function generatePDF(ticket, label, pvp, school, name, quantity) {
  return new Promise(async (resolve, reject) => {
    ...
    doc.fontSize(9).fillColor('#b0aca5')
      .font('Helvetica')
      .text('Presenta este QR en la entrada · Uso único · No transferible', pad, codeY + 20, { align: 'center', width: W - pad*2 });

    // Footer
    doc.fontSize(8).fillColor('#333333')
      .font('Helvetica')
      .text('© 2026 MTR YIN — Muay Thai Revolution · contacto@muaythairevolution.es', pad, H - 36, { align: 'center', width: W - pad*2 });
